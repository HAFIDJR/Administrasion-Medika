    ...
    <nav class="navbar navbar-expand-lg fixed-top">
        <div class="container">
            <a class="navbar-brand" href="#">
                <img src="https://www.svgrepo.com/show/500071/hospital.svg" alt="Logo" height="40"
                    class="me-2">
                {{ config('app.perusahaan', 'Medika Utama Blitar') }}
            </a>
        ...
        <div class="container">
            <div class="row align-items-center mt-3">
                ...
                <div class="col-lg-6 fade-in">
                    <img src="https://cdn.pixabay.com/photo/2021/11/20/03/35/doctor-6810776_1280.png"
