                        ...
                        <div class="d-flex align-items-center justify-content-center h-100">
                            <div class="col-10 col-xl-8 py-3">
                                <img class="img-fluid rounded mb-4" loading="lazy"
                                    src="https://nmu.co.id/wp-content/uploads/2023/05/Logo-Baru-PT-NMU-copy.png"
                                    width="245" height="80" alt="Logo">
                                <hr class="border-primary-subtle mb-4">
                                <h2 class="h1 mb-4">Selamat Datang Di Sistem Layanan Rumah Sakit Medika Utama Blitar
                                </h2>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-md-end">
                                        <a href="{{ route('login') }}" class="link-secondary text-decoration-none">Sign
                                            in Here</a>
