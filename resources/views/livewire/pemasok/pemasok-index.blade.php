                    ...
                    <tbody>
                        @foreach ($pemasok as $index => $pemasokItem)
                            <tr align="center">
                                ...
                                <td>
                                    <a href="{{ route('pemasok.edit', $pemasokItem->id) }}"
                                        class="btn btn-sm btn-warning">
                                        <i class="fas fa-edit"></i> Edit
                                    </a>
                                    <!-- Tombol Hapus -->
                                    <button type="button" class="btn btn-sm btn-danger" data-toggle="modal"
                                        data-target="#confirmDeleteModal{{ $pemasokItem->id }}">
                            ...
                            <div class="modal fade" id="confirmDeleteModal{{ $pemasokItem->id }}" tabindex="-1"
                                role="dialog" aria-labelledby="confirmDeleteModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <form wire:submit='deletePemasok({{ $pemasokItem->id }})'>
